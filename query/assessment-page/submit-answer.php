...
if (isset($_POST['user_id'])) {
    ...
    $insert2->bind_param("iii", $user_id, $assessment_id, $institution_id);
    $insert2->execute();
...
try {
    ...
    $mail->Subject = 'IMCCS Quiz Assessment Result';
                        ...
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td style="padding:0 35px;">
                                    <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;">' . $assessmentTitle . ' Score Result</h1>
                                    <span
                                        style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                    <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                        Good Day !, <b> ' . $fname . ' </b><br></br>
                                        We would like to inform you that you scored <br></br>
                                        <h1> ' . $score . ' / ' . $returnCountOver['point'] . ' </h1> on the <b> ' . $assessmentTitle . '</b> Assessment.<br></br>
