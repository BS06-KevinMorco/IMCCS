...
LEFT JOIN ( SELECT COUNT(DISTINCT answer.user_id) as total_choice_1,answer.question_id,question.assessment_question,question.assessment_choice1,question.assessment_choice2,question.assessment_choice3,question.assessment_choice4, question_answer FROM assessment_question_tbl question INNER JOIN answer_tbl answer ON question.assessment_id = answer.assessment_id INNER JOIN assessment_chosen assessment ON assessment.assessment_id = assessment.assessment_id INNER JOIN assessment_answer_tbl assessment_answer ON assessment_answer.question_id = question.question_id WHERE question.assessment_choice1 = answer.question_answer AND assessment.user_id = answer.user_id  AND assessment.assessment_id =?  AND answer.assessment_id =? AND answer.institution_id = ? AND assessment.institution_id = ?  GROUP BY answer.question_answer, answer.question_id ) as choice1 ON count_takers.question_id = choice1.question_id

 LEFT JOIN ( SELECT COUNT(DISTINCT answer.user_id) as total_choice_2,answer.question_id,question.assessment_question,question.assessment_choice1,question.assessment_choice2,question.assessment_choice3,question.assessment_choice4, question_answer FROM assessment_question_tbl question INNER JOIN answer_tbl answer ON question.assessment_id = answer.assessment_id INNER JOIN assessment_chosen assessment ON assessment.assessment_id = assessment.assessment_id INNER JOIN assessment_answer_tbl assessment_answer ON assessment_answer.question_id = question.question_id WHERE question.assessment_choice2 = answer.question_answer AND assessment.user_id = answer.user_id  AND assessment.assessment_id =?  AND answer.assessment_id =? AND answer.institution_id = ? AND assessment.institution_id = ?  GROUP BY answer.question_answer, answer.question_id ) as choice2 ON count_takers.question_id = choice2.question_id

 LEFT JOIN ( SELECT COUNT(DISTINCT answer.user_id) as total_choice_3,answer.question_id,question.assessment_question,question.assessment_choice1,question.assessment_choice2,question.assessment_choice3,question.assessment_choice4, question_answer FROM assessment_question_tbl question INNER JOIN answer_tbl answer ON question.assessment_id = answer.assessment_id INNER JOIN assessment_chosen assessment ON assessment.assessment_id = assessment.assessment_id INNER JOIN assessment_answer_tbl assessment_answer ON assessment_answer.question_id = question.question_id WHERE question.assessment_choice3 = answer.question_answer AND assessment.user_id = answer.user_id  AND assessment.assessment_id =?  AND answer.assessment_id =? AND answer.institution_id = ? AND assessment.institution_id = ?  GROUP BY answer.question_answer, answer.question_id ) as choice3 ON count_takers.question_id = choice3.question_id

 LEFT JOIN ( SELECT COUNT(DISTINCT answer.user_id) as total_choice_4,answer.question_id,question.assessment_question,question.assessment_choice1,question.assessment_choice2,question.assessment_choice3,question.assessment_choice4, question_answer FROM assessment_question_tbl question INNER JOIN answer_tbl answer ON question.assessment_id = answer.assessment_id INNER JOIN assessment_chosen assessment ON assessment.assessment_id = assessment.assessment_id INNER JOIN assessment_answer_tbl assessment_answer ON assessment_answer.question_id = question.question_id WHERE question.assessment_choice4 = answer.question_answer AND assessment.user_id = answer.user_id  AND assessment.assessment_id =?  AND answer.assessment_id =? AND answer.institution_id = ? AND assessment.institution_id = ?  GROUP BY answer.question_answer, answer.question_id ) as choice4 ON count_takers.question_id = choice4.question_id

 LEFT JOIN (
  SELECT COUNT(DISTINCT answer.user_id) as total_true, answer.question_id
  FROM assessment_question_tbl question
  INNER JOIN answer_tbl answer
...
LEFT JOIN (
  SELECT COUNT(DISTINCT answer.user_id) as total_false, answer.question_id
  FROM assessment_question_tbl question
  INNER JOIN answer_tbl answer
    INNER JOIN assessment_chosen assessment
      INNER JOIN assessment_answer_tbl assessment_answer
...
$assessmentTakerQuery = $mysqli->prepare("SELECT * from assessment_score WHERE assessment_id= ? AND institution_id = ?");
$assessmentTakerQuery->bind_param('si', $assessment_id, $selectedValue);
...
$overallScoreQuery = $mysqli->prepare("SELECT SUM(assessment_score) as total_score FROM assessment_score WHERE assessment_id = ?  AND institution_id = ?");
$overallScoreQuery->bind_param('si', $assessment_id, $selectedValue);
...
$overallQuestionQuery = $mysqli->prepare("SELECT SUM(point) as point  FROM answer_tbl WHERE assessment_id = ? AND institution_id = ?");
$overallQuestionQuery->bind_param('si', $assessment_id, $selectedValue);
...
$queryIdentificationQuestion = "SELECT *, COUNT(question_answer) as total FROM assessment_question_tbl question  JOIN answer_tbl answer ON question.question_id = answer.question_id AND question.assessment_id = answer.assessment_id WHERE question.type = 'Identification Question' GROUP BY question_answer ";
...
$tfAnswerQuery = "SELECT * FROM assessment_question_tbl question  JOIN answer_tbl answer ON question.question_id = answer.question_id AND question.assessment_id = answer.assessment_id WHERE question.type = 'True/False' ";
...
/*
$summaryAssessmentsQuery = "
SELECT count_takers.status, IF(choice1.total_choice_1 IS NULL, 0, choice1.total_choice_1) AS total_choice_1,IF(choice2.total_choice_2 IS NULL, 0, choice2.total_choice_2) AS total_choice_2,IF(choice3.total_choice_3 IS NULL, 0, choice3.total_choice_3) AS total_choice_3, IF(choice4.total_choice_4 IS NULL, 0, choice4.total_choice_4) AS total_choice_4,IF(count_right.total_right IS NULL, 0, count_right.total_right) AS total_right,IF(count_true.total_true IS NULL, 0, count_true.total_true) AS total_true,IF(count_false.total_false IS NULL, 0, count_false.total_false) AS total_false,count_takers.total_taker,IF(count_wrong.total_wrong IS NULL, 0, count_wrong.total_wrong) AS total_wrong,count_takers.question_id,count_takers.assessment_question,count_takers.assessment_choice1,count_takers.assessment_choice2,count_takers.assessment_choice3,count_takers.assessment_choice4, count_takers.assessment_answer, count_takers.type,count_takers.question_answer FROM ( SELECT COUNT(*) as total_taker, answer.question_id,assessment_question,assessment_choice1,assessment_choice2,assessment_choice3,assessment_choice4,question_answer,assessment_answer,status,type FROM assessment_chosen assessment INNER JOIN answer_tbl answer ON assessment.user_id=answer.user_id INNER JOIN assessment_question_tbl question INNER JOIN assessment_tbl as lists ON lists.assessment_id ='$assessment_id' WHERE question.question_id = answer.question_id  AND assessment.assessment_id ='$assessment_id'  AND answer.assessment_id ='$assessment_id' AND answer.institution_id = '$selectedValue'  AND assessment.institution_id = '$selectedValue' GROUP BY answer.question_id ) as count_takers

LEFT JOIN ( SELECT COUNT(*) as total_right, answer.question_id,assessment_question,question_answer,assessment_answer,answer.institution_id FROM assessment_question_tbl question INNER JOIN answer_tbl answer ON question.question_id = answer.question_id  WHERE question.assessment_answer = answer.question_answer AND answer.institution_id = '$selectedValue'  GROUP BY answer.question_id ) as count_right ON count_takers.question_id = count_right.question_id

LEFT JOIN ( SELECT COUNT(answer.user_id) as total_choice_1,answer.question_id,question.assessment_question,question.assessment_choice1,question.assessment_choice2,question.assessment_choice3,question.assessment_choice4, question_answer FROM assessment_question_tbl question INNER JOIN answer_tbl answer INNER JOIN assessment_chosen assessment WHERE question.assessment_choice1 = answer.question_answer AND assessment.user_id = answer.user_id AND assessment.assessment_id ='$assessment_id'  AND answer.assessment_id ='$assessment_id' AND answer.institution_id = '$selectedValue'  AND assessment.institution_id = '$selectedValue' GROUP BY answer.question_answer ) as choice1 ON count_takers.question_id = choice1.question_id

 LEFT JOIN ( SELECT COUNT(answer.user_id) as total_choice_2,answer.question_id,question.assessment_question,question.assessment_choice1,question.assessment_choice2,question.assessment_choice3,question.assessment_choice4, question_answer FROM assessment_question_tbl question INNER JOIN answer_tbl answer INNER JOIN assessment_chosen assessment WHERE question.assessment_choice2 = answer.question_answer AND assessment.user_id = answer.user_id AND assessment.assessment_id ='$assessment_id'  AND answer.assessment_id ='$assessment_id' AND answer.institution_id = '$selectedValue'  AND assessment.institution_id = '$selectedValue' GROUP BY answer.question_answer ) as choice2 ON count_takers.question_id = choice2.question_id

 LEFT JOIN ( SELECT COUNT(answer.user_id) as total_choice_3,answer.question_id,question.assessment_question,question.assessment_choice1,question.assessment_choice2,question.assessment_choice3,question.assessment_choice4, question_answer FROM assessment_question_tbl question INNER JOIN answer_tbl answer INNER JOIN assessment_chosen assessment WHERE question.assessment_choice3 = answer.question_answer AND assessment.user_id = answer.user_id AND assessment.assessment_id ='$assessment_id'  AND answer.assessment_id ='$assessment_id' AND answer.institution_id = '$selectedValue'  AND assessment.institution_id = '$selectedValue' GROUP BY answer.question_answer ) as choice3 ON count_takers.question_id = choice3.question_id

 LEFT JOIN ( SELECT COUNT(answer.user_id) as total_choice_4,answer.question_id,question.assessment_question,question.assessment_choice1,question.assessment_choice2,question.assessment_choice3,question.assessment_choice4, question_answer FROM assessment_question_tbl question INNER JOIN answer_tbl answer INNER JOIN assessment_chosen assessment WHERE question.assessment_choice4 = answer.question_answer AND assessment.user_id = answer.user_id AND assessment.assessment_id ='$assessment_id'  AND answer.assessment_id ='$assessment_id' AND answer.institution_id = '$selectedValue'  AND assessment.institution_id = '$selectedValue'  GROUP BY answer.question_answer ) as choice4 ON count_takers.question_id = choice4.question_id

LEFT JOIN ( SELECT COUNT(*) as total_wrong, answer.question_id,assessment_question,question_answer,assessment_answer FROM assessment_question_tbl question INNER JOIN answer_tbl answer ON question.question_id = answer.question_id WHERE question.assessment_answer != answer.question_answer AND answer.institution_id = '$selectedValue'  GROUP BY answer.question_id ) as count_wrong ON count_takers.question_id = count_wrong.question_id

LEFT JOIN ( SELECT COUNT(*) as total_true,answer.question_id FROM answer_tbl as answer WHERE question_answer = 'true' AND answer.institution_id = '$selectedValue' ) as count_true ON count_takers.question_id = count_true.question_id

  LEFT JOIN ( SELECT COUNT(*) as total_false,answer.question_id FROM answer_tbl as answer WHERE question_answer = 'false' AND answer.institution_id = '$selectedValue' ) as count_false ON count_takers.question_id = count_false.question_id

";

$resultSummaryAssessment = mysqli_query($mysqli, $summaryAssessmentsQuery);

//COUNT IF THERE ARE ANY RETURNED ROWS
$returnSummaryAssessmentRow = mysqli_num_rows($resultSummaryAssessment);



//COUNTS THE TOTAL OF ASSESSMENT TAKERS
$assessmentTakerQuery = "SELECT * FROM assessment_score WHERE assessment_id = '$assessment_id' AND institution_id = '$selectedValue'";
...
//COUNTS THE TOTAL OF SUM OF SCORES OF THE ASSESSMENT TAKERS
$overallScoreQuery = " SELECT SUM(assessment_score) as total_score FROM assessment_score WHERE assessment_id = '$assessment_id' AND institution_id = '$selectedValue'";
$resultScore = mysqli_query($mysqli, $overallScoreQuery);
$returnOverallScore = mysqli_fetch_assoc($resultScore);
//END

//COUNTS THE TOTAL NUMBER OF QUESTIONS PER ASSESSMENT TAKEN BY ALL ASSESSMENT TAKERS
/*$overallQuestionQuery = "SELECT * FROM assessment_question_tbl question INNER JOIN answer_tbl answer ON question.question_id = answer.question_id INNER JOIN assessment_chosen chosen ON chosen.assessment_id = answer.assessment_id WHERE question.assessment_id='$assessment_id' AND answer.institution_id = '$selectedValue' AND answer.user_id=chosen.user_id";
$resultOverallQuestion = mysqli_query($mysqli, $overallQuestionQuery);
$returnOverallQuestion = mysqli_num_rows($resultOverallQuestion);


$overallQuestionQuery = "SELECT SUM(point) as point  FROM answer_tbl WHERE assessment_id = '$assessment_id'";
$resultOverallQuestion = mysqli_query($mysqli, $overallQuestionQuery);
...
if (empty($returnAssessmentTaker)) {
    ...
    $averageInstitutionScore = $returnOverallScore['total_score'] / $returnAssessmentTaker;
    $institutionAssessmentRate = number_format($returnOverallScore['total_score'] / $returnOverallQuestion['point']  * 100);
}
?>
...
<?php
$identificationAnswer = array();
$queryIdentificationQuestion = "SELECT *, COUNT(question_answer) as total FROM assessment_question_tbl question  JOIN answer_tbl answer ON question.question_id = answer.question_id AND question.assessment_id = answer.assessment_id WHERE question.type = 'Identification Question' AND answer.institution_id = '$selectedValue' GROUP BY question_answer ";
...
if ($returnSummaryAssessmentRow->num_rows != 0) { ?>
    ...
    FROM assessment_question_tbl question
    JOIN answer_tbl answer ON question.question_id = answer.question_id AND question.assessment_id = '$assessment_id'
    WHERE question.type = 'Identification Question'
